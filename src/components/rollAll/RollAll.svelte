<script lang="ts">
    ...
    import { activeEntityTurnIndex, currentRound, entities, hasHelpTooltips, isTutorialOpen } from "../../store";
...
<div class="roll-all-container" transition:slide={{duration: $isTutorialOpen ? 0 : 400}}>
